...
export class Badge extends BaseComponent<BadgeProps> {
    ...
    public render(): void {
        ...
        if (variant === 'error') backgroundColor = 'var(--error, #f48771)';
        if (variant === 'warning') backgroundColor = 'var(--warning, #cca700)';
        if (variant === 'success') backgroundColor = 'var(--success, #89d185)';
