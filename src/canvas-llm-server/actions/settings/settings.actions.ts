...
export const updateUserSettingsAction: ServiceAction = {
    ...
    rest: { method: 'POST', path: '/settings' },
    auth: { required: true },
...
export const getWorkspaceSettingsAction: ServiceAction = {
    ...
    rest: { method: 'GET', path: '/workspaces/:workspaceId/settings' },
    auth: { required: true },
...
export const updateWorkspaceSettingsAction: ServiceAction = {
    ...
    rest: { method: 'POST', path: '/workspaces/:workspaceId/settings' },
    auth: { required: true },
